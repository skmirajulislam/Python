...
myPen.color("white")
myPen.goto(-90, -240)
myPen.write("Eid Mubarak", False, "center", ("Times New Roman", 38, "bold"))

myPen.goto(-310, -260)
myPen.write("May the blessing of Allah fill your life with happiness and success", False, "left", "9pt")

myPen.goto(-200, -180)
myPen.write('مبارك علينا وعليكم إن شاء الله',False,'left','9pt')

myPen.goto(-230, -320)
myPen.write("@ Presented By: Sk Mirajul islam", False, "left", ("0.5pt"))
